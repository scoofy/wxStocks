...
my_stock = return_stock_by_symbol(ticker)
for attribute in dir(my_stock):
	if attribute[:2] != "__":
		print my_stock.symbol + "." + attribute, "=", getattr(my_stock, attribute)
