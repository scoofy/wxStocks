...
{   # mispricing
    ...
    required_return,
    # realized_alpha
    actual_holding_period_return,
    contemporanious_required_return,
    # internal_rate_of_return
    year_ahead_dividend,
    estimated_dividend_growth_rate,
    "share_price", "LastSale_na"
    # equity_risk_premium_for_share_ver_1
    current_expected_risk_free_rate,
    "beta_i", "Beta_aa"
    # equity_risk_premium_for_share_ver_2
    current_expected_risk_free_rate,
    "beta_i", "Beta_aa"
    other_risk_premia=[],
    discounts_for_i=[],
    # equity_risk_premium_via_gordon_growth_model
    dividend_yield_on_index_based_on_year_ahead_aggeragate_forcasted_dividends_and_aggregate_market_value,
    consensus_long_term_earnings_growth_rate,
    current_long_term_govt_bond_yield,
    # equity_risk_premium_ibbotson_and_chen
    expected_inflation,
    ...
    # implicit_inflation_forcast_approximation
    treasury_bond_20_year_yield,
    treasury_inflation_protected_security_20_year_yield
    # CAPM_via_ERP
    expected_risk_free_rate,
    "beta_of_stock_i", "Beta_aa"
    "equity_risk_premium", CALC
    # CAPM
    risk_free_rate,
    beta_i,
    expected_return_on_market_portfolio,
    # adjusted_beta
    raw_beta
    # beta_estimate_for_private_or_thinly_traded_company
    beta_from_comparable,
    debt_of_comparable,
    equity_of_comparable,
    debt_of_target,
    equity_of_target
    # multifactor_model_basic
    risk_free_rate,
    stock,
    factor_sensitivity_and_risk_premium_attribute_name_tuple_list
    # fama_french_model
    risk_free_rate,
    beta_mkt_sub_i,
    beta_size_sub_i,
    ...
    "equity_risk_premium", CALC
    discount_list
    # bond_yield_plus_risk_premium_method
    yield_to_market_for_firms_long_term_debt,
    risk_premium_for_equity_specific_concerns,
    # equity_risk_premium_with_international_considerations
    equity_risk_premium_for_developed_markets,
    country_specific_premium
    # WACC
    market_value_of_debt,
    market_value_of_common_equity, "LastSale_na" x "CommonStockSharesIssued_us_gaap_us"
    required_return_on_equity,
    required_return_on_debt,
    marginal_tax_rate
    # return_on_invested_capital
    net_operating_profit_less_adjusted_taxes,
        "OperatingIncomeLoss_us_gaap_us" #look for most recent
        "IncomeTaxPaidNet_us_gaap_us" # hmmm
    operating_assets,
        "AssetsCurrent_us_gaap_us" + non-current-operating assets
    operating_liabilities,
    # return_on_capital_employed
    total_value_of_debt,
    total_value_of_equity,
    operating_profit,
    # present_value__holding_period_return
    number_of_payments,
    payment_list_or_value_if_stable,
    discount_rate,

    # dividend_discount_model_for_multiple_holding_periods
    number_of_periods,
    ...
    # gordon_growth_perpetuity
    capitalization_rate,
    dividend_amount,
    # no_growth_value_per_share
    capitalization_rate,
    earnings_next_period,
    # growth_value_per_share
    present_value_of_growth_opprotunities,
    capitalization_rate,
    earnings_next_period,
    # implied_PVGO
    share_price,
    ...
    # justified_leading_PE_via_gordon_growth
    equity_risk_premium,
    growth_rate,
    next_dividend_amount = None,
    ...
    # justified_trailing_PE_via_gordon_growth
    equity_risk_premium,
    growth_rate,
    current_dividend_amount = None,
    ...
    # IRR_via_gordon_growth
    current_share_price,
    dividend_growth_rate,

    current_dividend = None,
    next_period_dividend = None
    # two_stage_dividend_discount_model
    ...
    # H_model_dividend_discount
    half_life_in_years_of_high_growth_period,
    required_return_on_equity,
    current_dividend,
    short_term_dividend_growth_rate,
    long_term_dividend_growth_rate):
    # three_stage_dividend_discount_model
    number_of_first_stage_periods,
    ...
    current_time_period=1
    # three_stage_H_model_dividend_discount
    half_life_in_years_of_high_growth_period,
    number_of_first_stage_periods,
    number_of_second_stage_periods,
    required_return_on_equity,
    ...
    current_time_period = 1,
    # estimate_long_term_growth_rate
    long_term_retention_rate_estimate,
    long_term_ROE_or_required_return_estimate_or_median_industry_ROE,
    # implied_IRR_from_dividend_discounting
    half_life_in_years_of_high_growth_period,
    current_dividend,
    short_term_dividend_growth_rate,
    long_term_dividend_growth_rate,
    ...
    retention_rate,
    return_on_equity,
    # single_stage_FCFF_valuation
    weighted_avg_cost_of_capital,
    FCFF_growth_rate,
    ...
    # FCFE_via_FCFF
    free_cash_flow_to_the_firm,
    interest_expense,
    marginal_tax_rate,
    net_borrowing,
    # FCFE_via_income_statement
    net_income_available_to_common_shareholders,
    net_non_cash_charge,
    fixed_capital_investment,
    working_capital_investment,
    net_borrowing,
    # FCFE_via_cash_flow_statement
    cash_flow_from_operations,
    fixed_capital_investment,
    net_borrowing,
    # FCFF_via_EBIT
    ...
    net_income,
    debt_ratio,
    # FCFF_two_stage_model
    number_of_periods,
    FCFF_estimate_list,
    FCFF_growth_rate,
    WACC,
    current_time_period = 1,
    # FCFE_two_stage_model
    number_of_periods,
    FCFE_estimate_list,
    FCFE_growth_rate,
    required_return,
    ...
    value_of_nonoperating_assets,
    # pe_ratio
    current_price,
    earnings,
    # forward_pe_ratio_annual
    current_price,
    next_period_earnings,
    # forward_pe_ratio_quarterly
    current_price,
    EPS_estimate_list_for_next_four_quarters,
    # next_12_months_pe
    this_years_expected_earnings,
    ...
    # earnings_yield
    current_earnings,
    current_price, # or "inverse price ratio" # commonly used
    # price_to_book
    current_price,
    book_value_per_share,
    # book_to_market
    book_value_per_share,
    current_price, # commonly used
    # price_to_sales
    current_price,
    current_sales,
    # sales_to_price
    current_sales,
    current_price, # rarely used
    # price_to_cashflow
    current_price,
    current_cashflow,
    # cashflow_yield
    ...
    # price_to_dividend
    current_price,
    current_dividend, # rarely used
    # PEG_ratio
    current_price,
    some_earnings_measure,
    some_earnings_growth_measure,
    # yardeni_model
    current_earnings_yield_on_market_index,
    ...
    # price_to_book_via_BVPS
    current_price,
    book_value_per_share,
    # price_to_book_via_equity
    current_price,
    shareholders_equity,
    shares_outstanding,
    # price_to_book_via_assets_and_liabilities
    current_price,
    total_assets,
    total_labilities,
    shares_outstanding,
    ...
    # book_value_per_share_via_assets_and_liabilities
    total_assets,
    total_liabilities,
    number_of_common_shares,
    # common_shareholders_equity
    shareholder_equity,
    total_value_of_equity_claims_that_are_senior_to_common_stock,
    # justified_price_to_book_via_ROE
    ROE,
    earnings_growth,
    required_return_on_equity,
    # justified_price_to_book_via_residual_earnings
    current_book_value,
    present_value_of_expected_future_residual_earnings,
    ...
    EV,
    EBITDA,
    # enterprise_value_to_FCFF
    EV,
    FCFF,
    # enterprise_value_to_EBITDAR
    EV,
    EBITDAR, # + rent expense (used for airlines)
    # unexpected_earnings
    current_period_actual_earnings,
    current_period_expected_earnings,
    # economic_value_added
    net_operating_profit_after_taxes,
    cost_of_capital,
    total_capital,
    # market_value_added
    market_value_of_the_company,
    accounting_book_value_of_total_capital,
    # residual_income_constant_growth
    current_book_value,
    ROE,
    ROE_constant_growth_rate,
    required_return_on_equity,
    # tobins_q
    market_value_of_debt_and_equity,
    replacement_cost_of_total_assets, # not on exam
    # residual_income_multi_stage
    number_of_periods_in_stage_1,
    ...
    current_time_period = 1,
    # residual_income_multi_stage_via_ROE
    number_of_periods_in_stage_1,
    ...
    current_time_period = 1,
    # residual_income_multi_stage_declining
    number_of_periods_in_stage_1,
    list_of_earnings_in_stage_1,
    list_of_book_values_in_stage_1,
    current_book_value,
    ...
    # capitalized_CF_method_FCFF
    FCFF_next_period,
    WACC,
    growth_rate,
    # capitalized_CF_method_FCFE
    FCFE_next_period,
    required_return,
    growth_rate,
    # discount_for_lack_of_control
    control_premium, # not on exam
    # discount_for_lack_of_marketability
    marketability_premium # not on exam


    # current_ratio
    "current_assets": "AssetsCurrent_us_gaap_us",
    "current_liabilities": "AssetsCurrent_us_gaap_us",
    # quick_ratio
    "cash",  "CashAndCashEquivalentsAtCarryingValue_us_gaap_us"
    short_term_marketable_securities,
    receivables,
    current_liabilities, XXXX
    # cash_ratio
    cash, XXXX
    short_term_marketable_securities,
    current_liabilities, XXXX
    ...
    short_term_marketable_securities,
    receivables,
    daily_cash_expenditures,
    # receivables_turnover_ratio
    "total_revenue", "Revenues_us_gaap_us"
    average_receivables,
    ...
    total_revenue,
    # pretax_margin
    earnings_before_tax_but_after_interest,
    total_revenue,
    # net_profit_margin
    net_income,
    total_revenue,
    ...
    net_income,
    preferred_dividends,
    average_common_shareholders_equity,
    # tax_burden
    net_income,
    EBT,
    # interest_burden
    ...
    common_share_dividends,
    net_income_attributable_to_common_shares,
    # retention_rate_via_dividends
    net_income_attributable_to_common_shares,
    common_share_dividends,
    # retention_rate_via_payout_ratio
    payout_ratio,
    # sustainable_growth_rate
    retention_rate,
    ROE,
    ...
    net_income,
    preferred_dividends,
    weighted_average_number_of_ordinary_shares_outstanding,
    # BVPS
    common_shareholders_equity,
    total_number_of_common_shares_outstanding,
    # FCFE_via_CFO
    CFO,
    FCInv,
    net_borrowing,
    ...
    tax_rate,
    FCInv,
    # FIFO_inventory_via_LIFO_inventory
    LIFO_inventory,
    LIFO_reserve,
    # FIFO_COGS_via_LIFO_COGS
    LIFO_COGS,
    LIFO_reserve_0,
    LIFO_reserve_1,
    # FIFO_net_income_via_LIFO_net_income
    LIFO_net_income,
    LIFO_reserve_0,
    LIFO_reserve_1,
    tax_rate,
...
def implicit_inflation_forcast_approximation(treasury_bond_20_year_yield, treasury_inflation_protected_security_20_year_yield):
