...
class CustomAnalysisPage(object):
    ...
    accounts_drop_down = [(305, 31),(270,38),(238,31)][config.OS_TYPE_INDEX]
    clear_button = [(840,5),(default_width-110,5),(default_width-133,5)][config.OS_TYPE_INDEX]
    save_button = [(840,31),(default_width-110,37),(default_width-133,31)][config.OS_TYPE_INDEX]
