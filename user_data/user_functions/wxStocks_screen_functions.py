...
# You can also edit this file (user/user_functions/wxStocks_screen_functions.py) in your own text editor.

########################################### instructions #######################################################
# functions should be of the following form:

#	def your_full_screen_name(stock): # <--- the stock will be provided by the program, please keep this as "stock".
